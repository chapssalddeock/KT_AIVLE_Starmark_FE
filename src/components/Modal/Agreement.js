...
export default function Agreement({ modalOpen, setModalOpen }) {
    // 모달 끄기 
    const closeModal = () => {
        setModalOpen(false);
    };
    ...
    return (
        ...
        <>
            <Modal open={modalOpen} closable={false} footer={null} bodyStyle={{ maxHeight: '500px', overflowY: 'auto' }}>
                <h3>이용약관 및  개인정보 처리방침</h3><br />
                <p>여러분을 환영합니다.</p>
                <p>스타마크 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 스타마크 서비스의 이용과 관련하여 스타마크 서비스와 이를 이용하는 스타마크 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 스타마크 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.</p>
                <p>스타마크 서비스를 이용하시거나 스타마크 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.<br />
                    다양한 스타마크 서비스를 즐겨보세요.</p>
                <p>스타마크 기본적으로 여러분 모두에게 동일한 내용의 서비스를 제공합니다. 다만, '청소년보호법' 등 관련 법령이나 기타 개별 서비스 제공에서의 특별한 필요에 의해서 연령 또는 일정한 등급을 기준으로 이용자를 구분하여 제공하는 서비스의 내용, 이용 시간, 이용 횟수 등을 다르게 하는 등 일부 이용을 제한하는 경우가 있습니다. 자세한 내용은 역시 각 서비스 상의 안내, 공지사항, 고객센터 도움말 등에서 확인하실 수 있습니다.</p>
                <br />
                <h3> [필수] 개인정보의 수집 및 이용 </h3><br />
                <p>STARMARK(이하 '사이트'라 함)이 취급하는 모든 개인정보는 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하여 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.
                </p>
                <p><h6>1. 수집하는 개인정보</h6>
                ...
                <p><h6>5. 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</h6>
        ...
        설정방법 예(인터넷 익스플로어의 경우) : 웹 브라우저 상단의 도구 > 인터넷 옵션 > 개인정보<br />
                ...
                <p><h6>7. 개인정보에 관한 민원서비스</h6>
                    사이트는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 개인정보관리책임자를 지정하고 있습니다.<br />
                    이용자는 사이트의 서비스를 이용하시 q며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자에게 신고하실 수 있습니다. 사이트는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.<br />
                    <br />
                    개인정보 관리책임자<br />
                    •	성명: ■■■<br />
                    •	메일: ■■■<br />
